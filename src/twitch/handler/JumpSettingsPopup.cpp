...
void JumpSettingsPopup::onPlayer1(CCObject*) { if (m_onSelect) m_onSelect(1); this->onClose(nullptr); }
void JumpSettingsPopup::onPlayer2(CCObject*) { if (m_onSelect) m_onSelect(2); this->onClose(nullptr); }
void JumpSettingsPopup::onBoth(CCObject*) { if (m_onSelect) m_onSelect(3); this->onClose(nullptr); }

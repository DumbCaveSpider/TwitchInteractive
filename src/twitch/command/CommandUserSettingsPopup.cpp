...
void CommandUserSettingsPopup::onSave(CCObject* sender) {
    ...
    if (m_callback) m_callback(user, vip, mod, streamer, subscriber);
    onClose(sender);
}
